...
export default function ServicesPage(){
    ...
    return(
        <div className='bg-zinc-900 h-screen overflow-y-scroll duration-300'>
                        ...
                        {services.map((service) => (
                            <div key={service.id}>
                                <ScrollReveal animation="fadeInUp" delay={100}>
                                    <div className={`bg-zinc-800 p-8 border border-zinc-700 h-80 ${service.hoverColor} duration-300 group animate-fade-up`}>
                ...
                <div className="max-w-4xl mx-auto text-center px-6">
                    ...
                    <ScrollReveal animation="fadeInUp" delay={300}>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a href="https://wa.me/5516992416689" target="_blank" rel="noopener noreferrer" className="border border-zinc-600 hover:border-indigo-600 hover:text-indigo-400 text-zinc-300 px-8 py-4 text-lg font-medium transition-colors cursor-pointer quicksand duration-300">
