...
export default function Sobre(){
    ...
    return(
        <div className={`bg-white dark:bg-zinc-900 h-screen overflow-x-auto duration-300`}>
            ...
            <section className="py-12 bg-zinc-200/70 dark:bg-zinc-800/50">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-3xl lg:text-4xl font-bold mb-6 quicksand text-zinc-900 dark:text-white animate-fade-up animate-delay-[200ms]">
                                Nossa <span className="text-indigo-700 dark:animated-gradient-smooth">Missão</span>
                            </h2>
                            <p className="text-xl text-zinc-800 dark:text-zinc-300 mb-6 leading-relaxed inter animate-fade-up animate-delay-[400ms]">
                            ...
                            <p className="text-lg text-zinc-800 dark:text-zinc-300 leading-relaxed inter animate-fade-up animate-delay-[600ms]">
                        ...
                        <div className="relative">
                            <div className="bg-zinc-100 dark:bg-zinc-800 p-8 border border-zinc-400 dark:border-zinc-700 rounded-sm">
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-zinc-900 dark:text-white font-bold mb-2 quicksand animate-fade-up animate-delay-[200ms]">Soluções Integradas</h4>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-zinc-900 dark:text-white font-bold mb-2 quicksand animate-fade-up animate-delay-[800ms]">Resultados Comprovados</h4>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-zinc-900 dark:text-white font-bold mb-2 quicksand animate-fade-up animate-delay-[1600ms]">Equipe Especializada</h4>
            ...
            <section className="py-12 lg:py-16 bg-white dark:bg-zinc-900">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        <ScrollReveal animation="fadeInUp" delay={100}>
                            <h2 className="text-4xl font-bold mb-4 quicksand text-zinc-900 dark:text-white">
                                Nossa <span className="text-indigo-700 dark:animated-gradient-smooth">Abordagem</span>
                            </h2>
                        </ScrollReveal>
                        <ScrollReveal animation="fadeInUp" delay={300}>
                            <p className="text-xl text-zinc-800 dark:text-zinc-400 max-w-4xl mx-auto leading-relaxed inter">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                        ...
                        {/* Foco no Cliente */}
                        <ScrollReveal animation="fadeInUp" delay={100}>
                            <div className="bg-zinc-50 dark:bg-zinc-800 p-8 border border-zinc-400 hover:border-blue-600 dark:border-zinc-700 dark:hover:border-blue-500/50 duration-300 group rounded-sm">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-zinc-700 group-hover:bg-blue-600 border border-zinc-400 dark:border-zinc-600 p-4 mb-6 text-2xl duration-300 rounded-sm">
                                        <Target className="w-10 h-10 text-blue-600 dark:text-blue-500 group-hover:text-white duration-300" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white group-hover:text-blue-800 dark:group-hover:text-blue-400 duration-300 quicksand">
                                        Foco no Cliente
                                    </h3>
                                    <p className="text-zinc-800 dark:text-zinc-300 text-lg leading-relaxed inter">
                        ...
                        <ScrollReveal animation="fadeInUp" delay={200}>
                            <div className="bg-zinc-50 dark:bg-zinc-800 p-8 border border-zinc-400 hover:border-indigo-600 dark:border-zinc-700 dark:hover:border-indigo-500/50 duration-300 group rounded-sm">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-zinc-700 group-hover:bg-indigo-600 border border-zinc-400 dark:border-zinc-600 p-4 mb-6 text-2xl duration-300 rounded-sm">
                                        <Wrench className="w-10 h-10 text-indigo-600 dark:text-indigo-500 group-hover:text-white duration-300" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 duration-300 quicksand">
                                        Excelência Técnica
                                    </h3>
                                    <p className="text-zinc-800 dark:text-zinc-300 text-lg leading-relaxed inter">
                        ...
                        <ScrollReveal animation="fadeInUp" delay={300}>
                            <div className="bg-zinc-50 dark:bg-zinc-800 p-8 border border-zinc-400 hover:border-blue-600 dark:border-zinc-700 dark:hover:border-blue-500/50 duration-300 group rounded-sm">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-zinc-700 group-hover:bg-blue-600 border border-zinc-400 dark:border-zinc-600 p-4 mb-6 text-2xl duration-300 rounded-sm">
                                        <HandHeart className="w-10 h-10 text-blue-600 dark:text-blue-500 group-hover:text-white duration-300" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white group-hover:text-blue-800 dark:group-hover:text-blue-400 duration-300 quicksand">
                                        Parceria
                                    </h3>
                        ...
                        <ScrollReveal animation="fadeInUp" delay={100}>
                            <div className="bg-zinc-50 dark:bg-zinc-800 p-8 border border-zinc-400 hover:border-indigo-600 dark:border-zinc-700 dark:hover:border-indigo-500/50 duration-300 group rounded-sm">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-zinc-700 group-hover:bg-indigo-600 border border-zinc-400 dark:border-zinc-600 p-4 mb-6 text-2xl duration-300 rounded-sm">
                                        <Rocket className="w-10 h-10 text-indigo-600 dark:text-indigo-500 group-hover:text-white duration-300" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 duration-300 quicksand">
                                        Inovação
                                    </h3>
                        ...
                        <ScrollReveal animation="fadeInUp" delay={200}>
                            <div className="bg-zinc-50 dark:bg-zinc-800 p-8 border border-zinc-400 hover:border-blue-600 dark:border-zinc-700 dark:hover:border-blue-500/50 duration-300 group rounded-sm">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-zinc-700 group-hover:bg-blue-600 border border-zinc-400 dark:border-zinc-600 p-4 mb-6 text-2xl duration-300 rounded-sm">
                                        <Shield className="w-10 h-10 text-blue-600 dark:text-blue-500 group-hover:text-white duration-300" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white group-hover:text-blue-800 dark:group-hover:text-blue-400 duration-300 quicksand">
                                        Segurança
                                    </h3>
                        ...
                        <ScrollReveal animation="fadeInUp" delay={300}>
                            <div className="bg-zinc-50 dark:bg-zinc-800 p-8 border border-zinc-400 hover:border-indigo-600 dark:border-zinc-700 dark:hover:border-indigo-500/50 duration-300 group rounded-sm">
                                <div className="flex flex-col items-center text-center">
                                    <div className="bg-white dark:bg-zinc-700 group-hover:bg-indigo-600 border border-zinc-400 dark:border-zinc-600 p-4 mb-6 text-2xl duration-300 rounded-sm">
                                        <Zap className="w-10 h-10 text-indigo-600 dark:text-indigo-500 group-hover:text-white duration-300" />
                                    </div>
                                    <h3 className="text-2xl font-bold mb-4 text-zinc-800 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 duration-300 quicksand">
                                        Agilidade
                                    </h3>
            ...
            {/* CTA Section */}
            <section className="py-12 lg:py-20 bg-gradient-to-r from-zinc-200 dark:from-zinc-800">
                <div className="max-w-4xl mx-auto text-center px-6">
                    ...
                    <ScrollReveal animation="fadeInUp" delay={200}>
                        <p className="text-xl text-zinc-800 dark:text-zinc-300 mb-8 inter">
