...
export default function Sobre(){
    ...
    return(
        <div className={`bg-zinc-900 h-screen overflow-x-auto ${page === 'about' ? 'min-w-[100vw]' : 'min-w-0 text-nowrap'} duration-300`}>
            ...
            <section className="py-12 lg:py-20 bg-gradient-to-r from-zinc-800">
                <div className="max-w-4xl mx-auto text-center px-6">
                    ...
                    <button className="bg-blue-600 hover:bg-indigo-700 px-12 py-4 text-xl font-medium transition-colors inline-flex justify-center place-items-center items-center cursor-pointer group duration-300 lg:w-96 text-center" onClick={() => setPage('contact')}>
                        <p>Fale Conosco</p>
