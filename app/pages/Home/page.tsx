                ...
                <div className="relative max-w-7xl mx-auto px-6 py-10 xl:py-16">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <h1 className="text-xl lg:text-5xl font-bold leading-tight mb-6 text-white quicksand animate-fade-up animate-delay-[1600ms]">
                            Além do {' '}
                            <span className="animated-gradient-smooth">ERP</span>: ferramentas que{' '}
                            <span className="animated-gradient-smooth">impulsionam</span> sua operação
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button className="bg-blue-600 hover:bg-indigo-700 group text-white rounded-sm px-8 py-4 text-lg font-medium transition-colors flex items-center justify-center quicksand cursor-pointer lg:w-56 duration-300"
                            onClick={()=>setPage('contact')}>
                            Fale Conosco
                            <ArrowRight className="group-hover:ml-3 ml-1 w-5 h-5 duration-300" />
                            </button>
                            <button className="border border-zinc-600 hover:border-indigo-600 rounded-sm hover:text-indigo-500 text-zinc-400 px-8 py-4 text-lg font-medium transition-colors cursor-pointer quicksand duration-300"
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <ScrollReveal animation="fadeInUp" delay={100}>
                            <div className="text-center mb-16">
                                <h2 className="text-4xl font-bold mb-4 quicksand animated-gradient-smooth">Nossas Soluções</h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <ScrollReveal animation="fadeInUp" delay={100}>
                            <h2 className="text-4xl font-bold mb-6 quicksand">
                                Integração <span className="animated-gradient-smooth">Simples e Segura</span>
                            </h2>
                        </ScrollReveal>
                        ...
                        <div className="bg-zinc-800 border border-zinc-700 p-8 rounded-sm">
                            <div className="space-y-6">
                            <ScrollReveal animation="fadeInUp" delay={100}>
                                <div className="flex items-center space-x-4">
                                    <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-600 flex items-center justify-center rounded-sm">
                                    <span className="text-white font-bold">ERP</span>
                                    </div>
                                    <div className="flex-1">
                                    <div className="h-2 bg-zinc-600 mb-2 rounded-full"></div>
                                    <div className="h-2 bg-zinc-600 w-3/4 rounded-full"></div>
                                    </div>
                                </div>
                            </ScrollReveal>
                            ...
                            <ScrollReveal animation="fadeInUp" delay={200}>
                                <div className="flex items-center space-x-4 ml-8">
                                    ...
                                    <div className="flex-1">
                                    <div className="h-1.5 bg-blue-500 mb-1 rounded-full"></div>
                            ...
                            <ScrollReveal animation="fadeInUp" delay={300}>
                                <div className="flex items-center space-x-4 ml-8">
                                    ...
                                    <div className="flex-1">
                                    <div className="h-1.5 bg-indigo-500 mb-1 rounded-full"></div>
                                    <div className="h-1.5 bg-indigo-500 w-3/4 rounded-full"></div>
                                    </div>
                                </div>
                            </ScrollReveal>
                            ...
                            <ScrollReveal animation="fadeInUp" delay={400}>
                                <div className="flex items-center space-x-4 ml-8">
                                    ...
                                    <div className="flex-1">
                                    <div className="h-1.5 bg-blue-500 mb-1 rounded-full"></div>
                                    <div className="h-1.5 bg-blue-500 w-1/2 rounded-full"></div>
                                    </div>
                                </div>
                            </ScrollReveal>
                            ...
                            <ScrollReveal animation="fadeInUp" delay={500}>
                                <div className="flex items-center space-x-4 ml-8">
                                    ...
                                    <div className="flex-1">
                                    <div className="h-1.5 bg-indigo-500 mb-1 rounded-full"></div>
                                    <div className="h-1.5 bg-indigo-500 w-4/5 rounded-full"></div>
                                    </div>
                                </div>
                            </ScrollReveal>
