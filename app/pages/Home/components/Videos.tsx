        ...
        <div className="relative">
            <div className="bg-gradient-to-br from-blue-600/20 to-indigo-600/40 p-8 border border-zinc-700 rounded-sm h-[25rem] overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                    {/* Primeiro vídeo */}
                    <div className='bg-zinc-800 h-44 p-4 border border-zinc-700 rounded-sm overflow-hidden cursor-pointer transition-all duration-300 hover:bg-zinc-750'>
                        ...
                        <div className="animate-fade-up animate-delay-[1900ms]">
                            <p className="quicksand animated-gradient-smooth text-sm">
